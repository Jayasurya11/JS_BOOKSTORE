...
const SideBar = () => {
  ...
  return (
    ...
    <nav className="flex flex-col sm:w-screen lg:w-[250px]  lg:fixed top-0 left-0 justify-start lg:h-screen border bg-teal-300">
      <div className="flex justify-start  lg:justify-center gap-4 items-center border-b-2 border-gray-300 h-20">
        <img src={user?.photoURL || userImg} alt="" className="ml-4 lg:ml-0 w-12 h-12"/>
